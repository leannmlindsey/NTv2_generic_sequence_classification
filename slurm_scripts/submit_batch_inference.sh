#!/bin/bash
#
# Batch Inference Submission Script for NT-v2
#
...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        --help|-h)
            ...
            echo "  --model_path PATH    Path to fine-tuned model directory or HuggingFace model name"
            echo ""
            echo "Optional arguments:"
            echo "  --batch_size N       Batch size for inference (default: 16)"
...
echo "============================================================"
echo "NT-v2 Batch Inference Submission"
echo "============================================================"
...
while IFS= read -r INPUT_CSV || [ -n "${INPUT_CSV}" ]; do
    ...
    # Submit SLURM job
    JOB_ID=$(sbatch \
        --job-name="nt_inf_${INPUT_BASENAME}" \
